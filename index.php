...
<!-- Mirrored from clorova.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Sep 2018 06:09:14 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
        <meta charset="UTF-8"/>
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
        <title>Clorova | Bali &amp; Jakarta Photography, Video, 360 Media Production</title>
        ...
        <meta property="og:image" content="assets/img/general/clorova-banner.jpg"/>
        ...
        <meta name="twitter:image" content="assets/img/general/clorova-banner.jpg"/>
...
<div id="overlay">
  <div id="loading-items">
  	<a href="#" class="logo-loading" title="Clorova — Bali Media Production">
...
<div id="head" class="header">
	<a href="index.html" class="logo hover-target" id="main-logo" title="Clorova — Bali Media Production">
	...
	<a href="works.html" class="works q_magnet hover-target">All Works</a></li>
	    ...
	    <div class="section__content">
	    	...
	    	<header>
					<div class="header-wrap">
						<a href="http://fleava.com/" target="_blank" class="logo fleava hover-target" title="Fleava — Bali Digital Agency">
							<svg width="105px" height="24px">
	    	...
	    	<div class="menu-content">
						...
						<div class="columns">
							<div class="column q-1-5">
								<span class="line"></span>
								<a href="about.html" class="flare-hover hover-target barba_nav">
	                <h1 class="large">
	                  <span class="q_split"><span class="q_split_wrap menu-item">About</span> </span>
	                </h1>
	              </a>
							...
							<div class="column q-1-5">
								<span class="line"></span>
								<a href="journal.html" class="flare-hover hover-target barba_nav">
	                <h1 class="large">
	                  <span class="q_split"><span class="q_split_wrap menu-item">Journal</span> </span>
	                </h1>
	              </a>
	              <div class="text">
	              	<h5>Clorova Media Production</h5>
	              	<p>Specialising in lifestyle, interiors, 360 and aerial photography and videography, Clorova work across a range of advertising, editorial, pr and corporate clients in Bali and Jakarta.</p>
	              </div>
							</div>
							<div class="column q-1-5">
								<span class="line"></span>
								<a href="mailto:hello@clorova.com" title="Contact Clorova" class="flare-hover hover-target">
	                <h1 class="large">
	              ...
	              <div class="text">
	              	<h5>Find Us</h5>
	              	<p>#1 Beraban Square, Jalan Beraban No.46, Kerobokan, Badung, Bali - 80361, Indonesia</p>
	              	<p>
	              		<a class="hover-target" href="https://www.facebook.com/clorova/" target="_blank" title="Clorova on Facebook">Fb &nbsp; &nbsp;</a>
	              		<a class="hover-target" href="https://www.instagram.com/clorova_id/" target="_blank" title="Clorova on Instagram">Ig &nbsp; &nbsp;</a>
	              		<a class="hover-target" href="https://twitter.com/clorova" target="_blank" title="Clorova on Twitter">Tw &nbsp; &nbsp;</a>
	              		<a class="hover-target barba_nav" href="terms.html">Terms</a>
	              		<br><br>
	              		Website by <a href="http://fleava.com/" target="_blank" class="hover-target" title="Fleava Digital Agency">Fleava</a>.
	              	</p>
	              </div>
							</div>
...
<section id="q_slide" animate='stagTop' autoplay='8000' mousefollow kenburns parallax=".25" opacity=".3">
  <div class="q_slide-inner">
      <div class="slides">

        <div class="slide q_current" id="section-header">
          <div class="slide-content">
            <div class="caption">
              <h6>
                <span class="q_split"><span class="q_split_wrap">About</span> </span>
              </h6>
              <a href="about.html" class="flare-hover hover-target barba_home">
                <h1>
                  <span class="q_split"><span class="q_split_wrap">Excellence</span> </span>
                  <span class="q_split"><span class="q_split_wrap">Redefined</span> </span>
                </h1>
              </a>
          ...
          <div class="image-container">
            <div class="image-wrapper">
              <div class="kenburns">
                <img src="assets/img/about/banner.jpg" class="image" alt="About Clorova | Bali & Jakarta Photography, Video, 360 Media Production" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="slide" id="page-top-banner">
          <div class="slide-content">
            <div class="caption">
              <h6>
                <span class="q_split"><span class="q_split_wrap">Case Study</span> </span>
              </h6>
              <a href="works/prama.html" class="flare-hover hover-target barba_home">
                <h1 class="large">
                  <span class="q_split"><span class="q_split_wrap">Prama</span> </span>
                </h1>
              </a>
          ...
          <div class="image-container">
            <div class="image-wrapper">
              <div class="kenburns">
                <img src="assets/img/works/prama/banner.jpg" alt="Prama Sanur by Clorova" class="image" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="slide" id="page-top-banner">
          <div class="slide-content">
            <div class="caption">
              ...
              <a href="works/the-ocean.html" class="flare-hover hover-target barba_home">
                <h1 class="large">
                  <span class="q_split"><span class="q_split_wrap">The</span> </span>
                  <span class="q_split"><span class="q_split_wrap">Ocean</span> </span>
                </h1>
              </a>
          ...
          <div class="image-container">
            <div class="image-wrapper">
              <div class="kenburns">
                <img src="assets/img/works/ocean/banner.jpg" alt="The Ocean Champagne Bar by Clorova" class="image" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="slide" id="page-top-banner">
          <div class="slide-content">
            <div class="caption">
              ...
              <a href="works/the-acala.html" class="flare-hover hover-target barba_home">
                <h1 class="large">
                  <span class="q_split"><span class="q_split_wrap">The</span> </span>
                  <span class="q_split"><span class="q_split_wrap">Acala</span> </span>
                </h1>
              </a>
            </div>
          </div>
          <div class="image-container">
            <div class="image-wrapper">
              <div class="kenburns">
                <img src="assets/img/works/acala/banner.jpg" alt="The Acala by Clorova" class="image" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="pagination">
        <div class="item hover-target q_current"><span><strong>01</strong></div>
        <div class="item hover-target"><span><strong>02</strong></div>
        <div class="item hover-target"><span><strong>03</strong></div>
        <div class="item hover-target"><span><strong>04</strong></div>
      </div>



      <div class="arrows">
        <a class="arrow next q_magnet hover-target" friction=".3">
        ...
        <a class="arrow prev q_magnet hover-target" friction=".3">
...
<!-- Mirrored from clorova.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Sep 2018 06:09:54 GMT -->
</html>